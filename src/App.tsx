...
export function App() {
  ...
  const currentMonthEvals: Record<CircleName, MonthlyCircleEvaluation> = evaluations[targetYearMonth] || {
    '금메달': { circleName: '금메달', yearMonth: targetYearMonth, scores: calculateTotalScore({ maintDefectCount: 0, meetingCount: 0, prevThemeStep: '1단계 - 테마주제선정', currThemeStep: '1단계 - 테마주제선정', planAchievementRate: 0, themeGrade: '미완료', themeCumulativeCount: 0, totalProposalCount: 0, totalUnreasonableCount: 0, unreasonableResolveRate: 0 }, 10) },
    '한마음': { circleName: '한마음', yearMonth: targetYearMonth, scores: calculateTotalScore({ maintDefectCount: 0, meetingCount: 0, prevThemeStep: '1단계 - 테마주제선정', currThemeStep: '1단계 - 테마주제선정', planAchievementRate: 0, themeGrade: '미완료', themeCumulativeCount: 0, totalProposalCount: 0, totalUnreasonableCount: 0, unreasonableResolveRate: 0 }, 10) },
    '독수리': { circleName: '독수리', yearMonth: targetYearMonth, scores: calculateTotalScore({ maintDefectCount: 0, meetingCount: 0, prevThemeStep: '1단계 - 테마주제선정', currThemeStep: '1단계 - 테마주제선정', planAchievementRate: 0, themeGrade: '미완료', themeCumulativeCount: 0, totalProposalCount: 0, totalUnreasonableCount: 0, unreasonableResolveRate: 0 }, 10) },
    '아리울': { circleName: '아리울', yearMonth: targetYearMonth, scores: calculateTotalScore({ maintDefectCount: 0, meetingCount: 0, prevThemeStep: '1단계 - 테마주제선정', currThemeStep: '1단계 - 테마주제선정', planAchievementRate: 0, themeGrade: '미완료', themeCumulativeCount: 0, totalProposalCount: 0, totalUnreasonableCount: 0, unreasonableResolveRate: 0 }, 10) },
    '새만금': { circleName: '새만금', yearMonth: targetYearMonth, scores: calculateTotalScore({ maintDefectCount: 0, meetingCount: 0, prevThemeStep: '1단계 - 테마주제선정', currThemeStep: '1단계 - 테마주제선정', planAchievementRate: 0, themeGrade: '미완료', themeCumulativeCount: 0, totalProposalCount: 0, totalUnreasonableCount: 0, unreasonableResolveRate: 0 }, 10) },
  };
